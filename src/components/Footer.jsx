    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/dipakpatil1"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/dipak_patil_16?igsh=b2VoYmw1Y3FvdXFs"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://www.linkedin.com/in/dipak-patil-535321202/"><i className="ri-linkedin-fill ri-2x"></i></a>
        </div>
