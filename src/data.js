...
export const listProyek = [
  ...
  },
  {
    id: 1,
    image: Proyek1,
    title: "Url's Shortner App",
    subtitle: "A mobile application powered by Artificial Intelligence...",
    fullDescription:"his URL Shortener project works by taking a long URL from the user and converting it into a short and unique link. When a user enters a URL, the server receives the request through REST APIs built with Express.js. The backend then validates the URL and generates a unique short code for it. After generating the short code, the original URL and shortened URL are stored in MongoDB using database operations.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/dipakpatil1/Url-s-Shortner-app",
    dad: "100",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/rissss212",
    dad: "300",
  },
    ...
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/rissss2122",
    dad: "500",
  },
  {
    id: 6,
